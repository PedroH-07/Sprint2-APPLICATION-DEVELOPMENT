# Para utilizar a aplicação instale a extensão Live Server no seu editor de código e clique com o botão direito no Index.html para ver a aplicação rodando.
----------------------------------------------------
